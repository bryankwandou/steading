...
const en = {
  ...
  'live.paste': "The box for pasting a video link is inside the app itself, not on this page. This page cannot download — that is what the diagram above is about.",
...
const id = {
  ...
  'live.paste': "Kotak untuk menempel tautan video ada di dalam aplikasinya, bukan di halaman ini. Halaman ini tidak bisa mengunduh — itulah yang dijelaskan diagram di atas.",
